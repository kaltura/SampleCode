...
namespace WrapperCielo24
{
    ...
    public abstract class BaseOptions
    {
        ...
        protected string GetStringValue(object value)
        {
            ...
            {
                // TODO: if null return empty string
    ...
    public class TranscriptOptions : BaseOptions
    {
        ...
        public Dictionary<string, string> GetTranscriptionDictionary()
        {
    ...
    public class CaptionOptions : BaseOptions
    {
        // DEFAULTS //
        ...
        // TODO get caption can return url
        ...
        public SpeakerId DisplaySpeakerId { get; set; } // Default: "name" ["no","number", "name"]
        ...
        public int MinimumGapBetweenCaptionsMs{ get; set; } // Default:
        ...
        public CaptionOptions(int charactersPerCaptionLine = 42, DateTime? elementListVersion = null, string speakerChangeToken = ">>", bool maskProfanity = false,
            ...
            string effectsSpeaker="Effects", SpeakerId displaySpeakerId=SpeakerId.name, bool forceCase=false /*TODO*/, bool includeDfxpMetadata=true,
            int layoutDefaultCaptionLengthMs=5000, bool lineBreakOnSentence=false, LineEnding lineEndingFormat=LineEnding.UNIX,
            int linesPerCaption=2, int maximumCaptionDuration=0, int mergeGapInterval=1000, int minimumCaptionLengthMs=0, int minimumGapBetweenCaptionsMs=0,
            int minimumMergeGapInterval=0, bool qtSeamless=false, int silenceMaxMs=2000, bool singleSpeakerPerCaption=false, int soundThreshold=0,
