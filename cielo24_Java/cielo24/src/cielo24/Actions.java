...
public class Actions {
    ...
    public Guid performTranscription(Guid apiToken,
                                     ...
                                     PerformTranscriptionOptions options) throws IOException, WebException, IllegalArgumentException, IllegalAccessException {
        Dictionary<String, String> queryDictionary = initJobReqDict(apiToken, jobId);
        ...
        if (options != null) { queryDictionary.addAll(options.GetDictionary()); }
    ...
    public String getTranscript(Guid apiToken, Guid jobId, TranscriptOptions transcriptOptions) throws IOException, WebException, IllegalArgumentException, IllegalAccessException {
        Dictionary<String, String> queryDictionary = initJobReqDict(apiToken, jobId);
        if (transcriptOptions != null) { queryDictionary.addAll(transcriptOptions.GetDictionary()); }
    ...
    /* Returns a caption from a job with jobId OR if buildURL is true, returns a String representation of the uri */
    public String getCaption(Guid apiToken, Guid jobId, CaptionFormat captionFormat, CaptionOptions captionOptions) throws IOException, WebException, IllegalArgumentException, IllegalAccessException {
        Dictionary<String, String> queryDictionary = initJobReqDict(apiToken, jobId);
        queryDictionary.add("caption_format", captionFormat.toString());
        if (captionOptions != null) { queryDictionary.addAll(captionOptions.GetDictionary()); }
    ...
    public String getCaption(Guid apiToken, Guid jobId, CaptionFormat captionFormat) throws IOException, WebException, IllegalArgumentException, IllegalAccessException  {
    ...
    private void assertArgument(String arg, String arg_name) {
        if (arg == null || arg.equals("")) { throw new IllegalArgumentException("Invalid " + arg_name); }
    }

    private void assertArgument(Object arg, String arg_name) {
        if (arg == null) { throw new IllegalArgumentException("Invalid " + arg_name); }
    }
}